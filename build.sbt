...
val awsSdkVersion = "2.624.0"
val awsSdkScalajsFacadeVersion = s"0.29.0-v${awsSdkVersion}"
...
libraryDependencies += "net.exoego" %%% "aws-sdk-scalajs-facade-rekognition" % awsSdkScalajsFacadeVersion
